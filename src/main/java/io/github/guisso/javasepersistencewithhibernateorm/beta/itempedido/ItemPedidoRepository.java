...
public class ItemPedidoRepository
        extends Repository<ItemPedido> {

    @Override
    public String getJpqlFindAll() {
        return "SELECT i FROM ItemPedido i";
    }

    @Override
    public String getJpqlFindById() {
        return "SELECT i FROM ItemPedido i WHERE i.id = :id";
    }

    @Override
    public String getJpqlDeleteById() {
        return "DELETE FROM ItemPedido i WHERE i.id = :id";
    }
